...
import org.apache.thrift.protocol.*;
  ...
  public class ImagingImpl implements Imaging {
    public function ImagingImpl(iprot:TProtocol, oprot:TProtocol=null)
    {
      iprot_ = iprot;
      if (oprot == null) {
        oprot_ = iprot;
    ...
    public function mandelbrot(w:int, h:int, onError:Function, onSuccess:Function):void
    {
      oprot_.writeMessageBegin(new TMessage("mandelbrot", TMessageType.CALL, seqid_));
      ...
      oprot_.getTransport().flush(function(error:Error):void {
        try {
          ...
          if (result.ouch != null) {
            if (onError != null) onError(result.ouch);
            return;
          }
          if (onError != null) onError(new TApplicationError(TApplicationError.MISSING_RESULT, "mandelbrot failed: unknown result"));
        } catch (e:TError) {
    ...
    //function onError(Error):void;
    //function onSuccess(byte[]):void;
    public function transform(t:int, img:byte[], onError:Function, onSuccess:Function):void
    {
      ...
      oprot_.getTransport().flush(function(error:Error):void {
        try {
          ...
          if (onError != null) onError(new TApplicationError(TApplicationError.MISSING_RESULT, "transform failed: unknown result"));
        } catch (e:TError) {
          if (onError != null) onError(e);
        }
      });
...
class transform_args implements TBase {
  ...
  public function get img():byte[] {
    return this._img;
  }

  public function set img(img:byte[]):void {
    this._img = img;
  }
