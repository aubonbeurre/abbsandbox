...
uint32_t Imaging_xgradient_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Imaging_xgradient_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("Imaging_xgradient_args");
  xfer += oprot->writeFieldBegin("t", ::apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32((int32_t)this->t);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("img", ::apache::thrift::protocol::T_STRING, 2);
...
uint32_t Imaging_xgradient_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("Imaging_xgradient_pargs");
  xfer += oprot->writeFieldBegin("t", ::apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32((int32_t)(*(this->t)));
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("img", ::apache::thrift::protocol::T_STRING, 2);
...
uint32_t Imaging_xgradient_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Imaging_xgradient_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Imaging_xgradient_result");
...
uint32_t Imaging_xgradient_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void ImagingClient::xgradient(std::string& _return, const Transform::type t, const std::string& img)
{
  send_xgradient(t, img);
  recv_xgradient(_return);
}

void ImagingClient::send_xgradient(const Transform::type t, const std::string& img)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("xgradient", ::apache::thrift::protocol::T_CALL, cseqid);

  Imaging_xgradient_pargs args;
  args.t = &t;
  args.img = &img;
  args.write(oprot_);
...
void ImagingClient::recv_xgradient(std::string& _return)
{
  ...
  if (fname.compare("xgradient") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  Imaging_xgradient_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "xgradient failed: unknown result");
}
...
void ImagingProcessor::process_xgradient(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("Imaging.xgradient", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "Imaging.xgradient");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "Imaging.xgradient");
  }

  Imaging_xgradient_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "Imaging.xgradient", bytes);
  }

  Imaging_xgradient_result result;
  try {
    iface_->xgradient(result.success, args.t, args.img);
    result.__isset.success = true;
  } catch (InvalidOperation &ouch) {
    result.ouch = ouch;
    result.__isset.ouch = true;
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "Imaging.xgradient");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("xgradient", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "Imaging.xgradient");
  }

  oprot->writeMessageBegin("xgradient", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "Imaging.xgradient", bytes);
  }
}
