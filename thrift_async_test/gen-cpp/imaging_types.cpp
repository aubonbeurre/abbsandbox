...
//const std::map<int, const char*> _Transform_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kTransformValues, _kTransformNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
